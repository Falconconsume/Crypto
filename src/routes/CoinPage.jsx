        ...
        <div>
          ...
          <div className="flex justify-between py-4">
            ...
            <div>
              ...
              {coin.tickers ? (
                <p>{coin.sentiment_votes_down_percentage.toFixed(2)}</p>
              ) : null}
            </div>
          </div>
          ...
          <div className="flex justify-between py-4">
            ...
            <div>
              <p className="text-gray-500 font-bold">Price Change(7d)</p>
              {coin.market_data ? (
                <p>{coin.market_data.price_change_percentage_7d.toFixed(2)}%</p>
              ) : null}
            </div>
            <div>
              <p className="text-gray-500 font-bold">Price Change(14d)</p>
              {coin.market_data ? (
                <p>
          ...
          <div>
            <div className="flex justify-between py-4">
              <div>
                <p className="text-gray-500 font-bold">Price Change (30d)</p>
                {coin.market_data ? (
                  <p>
              ...
              <div>
                <p className="text-gray-500 font-bold">Price Change (60d)</p>
                {coin.market_data ? (
                  <p>
